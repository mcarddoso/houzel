...
export default function Home() {
  ...
  return (
    <main className="text-black [background:linear-gradient(180deg,#FFFFFF_0%,#EDEDED_100%)]">
      ...
      <div className="flex w-full flex-row justify-start flex-wrap items-start gap-2 md:gap-6 px-0 md:px-5 xl:px-[80px] 2xl:px-[132px]">
        <BentoGrid>
      ...
      <div className="px-0 md:px-5 xl:px-[80px] 2xl:px-[132px]">
        ...
        <div className="flex flex-col animate-home-view-show">
          ...
          <p className="text-[var(--text-disable)] text-center text-sm my-5">All tasks and websites shown in the community are voluntarily shared by users. The platform does not display any content without user consent.</p>
